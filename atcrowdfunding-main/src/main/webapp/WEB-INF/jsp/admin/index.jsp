			...
			<div class="tree">
				<ul style="padding-left:0px;" class="list-group">
					...
					<c:if test="${not empty parent.children }">
						<li class="list-group-item tree-closed">
						<span><i class="${parent.icon }"></i> ${parent.name }<span
								class="badge" style="float: right">${parent.children.size()}</span></span>
...
<form class="form-inline" role="form" style="float:left;" id="queryForm" action="${PATH }/admin/index" method="post">
              ...
              <tbody>
                ...
                <c:forEach items="${page.list}" var="admin" varStatus="status">
	                <tr>
	                  ...
	                  <td>${admin.email }</td>
	                  <td>
					      <button type="button" onclick="window.location.href='${PATH}/admin/toAssign?id=${admin.id }'" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-check"></i></button>
